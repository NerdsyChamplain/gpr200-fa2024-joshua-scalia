...
//textures
	...
	unsigned int modelLoc = glGetUniformLocation(backShader.ID, "model");
	unsigned int viewLoc = glGetUniformLocation(backShader.ID, "view");
	unsigned int projectionLoc = glGetUniformLocation(backShader.ID, "projection");
